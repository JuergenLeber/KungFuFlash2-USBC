...
static const struct usb_string_descriptor prod_desc_en  = USB_STRING_DESC("Kung Fu Flash 2");
...
/******************************************************************************
* Configure USB OTG_HS (PA11/PA12)
******************************************************************************/
static void usb_config(void)
{
	...
	// Set PA11 and PA12 output speed to high speed
    MODIFY_REG(GPIOA->OSPEEDR, GPIO_OSPEEDR_OSPEED11|GPIO_OSPEEDR_OSPEED12,
               GPIO_OSPEEDR_OSPEED11_1|GPIO_OSPEEDR_OSPEED12_1);

    // Set output type to push-pull
    MODIFY_REG(GPIOA->OTYPER, GPIO_OTYPER_OT11|GPIO_OTYPER_OT12, 0);

    // No pull-up or pull-down
    MODIFY_REG(GPIOA->PUPDR, GPIO_PUPDR_PUPD11|GPIO_PUPDR_PUPD12, 0);

    // Set PA11 and PA12 to AF10 (OTG_HS)
